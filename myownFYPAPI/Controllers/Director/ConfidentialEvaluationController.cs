...
{
    [RoutePrefix("api/director/confidential-evaluation")]
    public class ConfidentialEvaluationController : ApiController
    {
        ...
        public IHttpActionResult GetEvaluations([FromBody] EmailRequest request)
        {
            try
            {
                ...
                using (var client = new ImapClient())
                {
                    ...
                    query = query.And(SearchQuery.SubjectContains("Confidential Evaluation"));
